<template>
    <div class="select" v-show="slectState">
        <header style="left:100%" class="h-100 w-per-100  p-f-xl-yt bg-linear-header p-lr-30 f-b-c z-1000">
        ...
        <div style="left:100%" class="w-per-100 m-t-100 p-f-xl-yt  bg-color-fff">
